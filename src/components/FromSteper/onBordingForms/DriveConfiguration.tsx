...
const DriveConfiguration = (props: Props) => {
  return (
    <div>
      <div className="text-white border-b border-gray-700 pb-4">
        <h1 className="text-lg font-semibold">Document Repository Path</h1>
        <p className="text-sm pt-2">
          Provide path for your official document repository
        </p>
      </div>
      <label className="block mb-2 text-sm font-medium text-white dark:text-white pt-4">
